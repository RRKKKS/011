...
return send(data.chat_id,data.id,"※ الوضع المجاني معطل من قبل مطور الصانع @ww_2_2")
end
if text == "※ الغاء" then
Redis:del(Fast..data.sender_id.user_id.."bottoken")
Redis:del(Fast..data.sender_id.user_id.."dev:user")
...
send(data.chat_id,data.id,"※ اهلا بك في صانع بوتات ميوزك سورس ارنوب \n※ قناه السورس البوت @N_G_12 \n مبرمج السورس: @ww_2_2 ","html",true, false, false, true, reply_markup)
return false 
end
---making user
